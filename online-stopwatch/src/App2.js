...
//                         <button onClick={this.startClick} className="btn btn-success" disabled={btnDisabled}>Start</button>
//                     </div>
//                     <div className="timer-btn">
//                         <button onClick={this.stopClick} className="btn btn-danger">Stop</button>
//                     </div>
//                     <div className="timer-btn">
//                         <button onClick={this.intervalClick} className="btn btn-secondary" disabled={!btnDisabled}>Interval</button>
//                     </div>
//                     <div className="timer-btn">
